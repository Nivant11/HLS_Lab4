...
set C_modelArgList {
	{ input_r int 16 regular {array 100 { 2 3 } 1 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "input_r", "interface" : "memory", "bitwidth" : 16, "direction" : "READWRITE"} ]}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "3553", "Max" : "3553"}
	, {"Name" : "Interval", "Min" : "3553", "Max" : "3553"}
]}
...
set Spec2ImplPortList { 
	input_r { ap_memory {  { input_r_address0 mem_address 1 7 }  { input_r_ce0 mem_ce 1 1 }  { input_r_we0 mem_we 1 1 }  { input_r_d0 mem_din 1 16 }  { input_r_q0 mem_dout 0 16 } } }
}
